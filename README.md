...
- **Dual LLM with automatic fallback** — Groq `openai/gpt-oss-120b` primary; falls back to Google Gemini `gemini-2.5-flash` on rate-limit, quota exhaustion, or model unavailability with no user-visible error
